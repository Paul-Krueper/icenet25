...
legend_loc=["upper left","upper right","upper right", "upper right", "upper right", "upper right", "upper right", "upper left", "upper right", "upper left", "upper right", "upper left", "upper left"]
...
for idx,v in enumerate(shape_var_list):
    ...
    hists['mc_rwgt'] = np.histogram(input_mc[v], nbins, (lo,hi), weights=input_mc['w_post_S2_unnorm'])
    hists['mc_rwgt_sumw2'] = np.histogram(input_mc[v], nbins, (lo,hi), weights=input_mc['w_post_S2_unnorm']**2)
